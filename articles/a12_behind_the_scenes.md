...
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00001_on_2026_08_10_at_07_48_19.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
#> time_taken: 0.043 seconds
#> sql: <SQL>
#>   SELECT DISTINCT concept.concept_id AS concept_id
#>   FROM concept
#>   INNER JOIN results.test_og_003_1786348099
#>     ON (concept.concept_id = test_og_003_1786348099.concept_id)" 
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00002_on_2026_08_10_at_07_48_19.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00003_on_2026_08_10_at_07_48_19.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
#> name: tmp_001_og_004_1786348099
#> temporary: FALSE
#> overwrite: TRUE
#> log_prefix: CohortConstructor_uploadCohortCodelist
#> time_taken: 0.140 seconds
#> sql: <SQL>
#>   SELECT
...
#>   FROM (
#>     SELECT test_tmp_001_og_004_1786348099.*, domain_id
#>     FROM results.test_tmp_001_og_004_1786348099
#>     LEFT JOIN concept
#>       ON (test_tmp_001_og_004_1786348099.concept_id = concept.concept_id)
#>   ) AS q01" 
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00004_on_2026_08_10_at_07_48_19.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00005_on_2026_08_10_at_07_48_19.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00006_on_2026_08_10_at_07_48_19.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00007_on_2026_08_10_at_07_48_19.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00008_on_2026_08_10_at_07_48_19.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00009_on_2026_08_10_at_07_48_20.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
#> name: tmp_001_og_005_1786348100_1
#> temporary: FALSE
#> overwrite: TRUE
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00010_on_2026_08_10_at_07_48_20.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
...
#> overwrite: TRUE
#> log_prefix: CohortConstructor_tempCohort_
#> time_taken: 0.225 seconds
#> sql: <SQL>
#>   SELECT cohort_definition_id, subject_id, cohort_start_date, cohort_end_date
#>   FROM results.test_tmp_001_og_005_1786348100_1
#>   INNER JOIN results.test_tmp_001_temp_codelist_cohort_id
#>     ON (test_tmp_001_og_005_1786348100_1.concept_id = test_tmp_001_temp_codelist_cohort_id.concept_id)" 
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00011_on_2026_08_10_at_07_48_20.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00012_on_2026_08_10_at_07_48_20.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00013_on_2026_08_10_at_07_48_20.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00014_on_2026_08_10_at_07_48_20.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00015_on_2026_08_10_at_07_48_20.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00016_on_2026_08_10_at_07_48_20.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00017_on_2026_08_10_at_07_48_20.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00018_on_2026_08_10_at_07_48_21.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00019_on_2026_08_10_at_07_48_21.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00020_on_2026_08_10_at_07_48_21.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
#> time_taken: 0.022 seconds
#> sql: <SQL>
#>   SELECT *
#>   FROM results.test_drugs
#>   LIMIT 1" 
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00021_on_2026_08_10_at_07_48_21.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00022_on_2026_08_10_at_07_48_21.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00023_on_2026_08_10_at_07_48_21.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00024_on_2026_08_10_at_07_48_22.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00025_on_2026_08_10_at_07_48_22.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00026_on_2026_08_10_at_07_48_22.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00027_on_2026_08_10_at_07_48_22.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00028_on_2026_08_10_at_07_48_22.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
#> name: og_010_1786348103
#> temporary: FALSE
#> overwrite: TRUE
#> log_prefix: CohortConstructor_joinOverlap_workingTbl_
#> time_taken: 0.286 seconds
#> sql: <SQL>
#>   SELECT
#>     cohort_definition_id,
#>     subject_id,
...
#>     SELECT
#>       *,
#>       SUM(TRY_CAST(is_new_era AS INTEGER)) OVER (PARTITION BY cohort_definition_id, subject_id ORDER BY cohort_start_date, cohort_end_date ROWS UNBOUNDED PRECEDING) AS era_id
#>     FROM (
#>       SELECT
#>         *,
#>         CASE WHEN (cohort_start_date > prev_max) THEN 1 WHEN NOT (cohort_start_date > prev_max) THEN 0 ELSE 1 END AS is_new_era
#>       FROM (
#>         SELECT
#>           *,
#>           LAG(running_max, 1, NULL) OVER (PARTITION BY cohort_definition_id, subject_id ORDER BY cohort_start_date, cohort_end_date) AS prev_max
#>         FROM (
#>           SELECT
#>             *,
#>             MAX(cohort_end_date) OVER (PARTITION BY cohort_definition_id, subject_id ORDER BY cohort_start_date, cohort_end_date ROWS UNBOUNDED PRECEDING) AS running_max
#>           FROM results.test_drugs
#>         ) AS q01
#>       ) AS q01
#>     ) AS q01
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00029_on_2026_08_10_at_07_48_22.txt
#> 
#> "type: compute
#> schema: results
#> prefix: test_
...
#> sql: <SQL>
#>   SELECT DISTINCT *
#>   FROM results.test_og_010_1786348103" 
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00030_on_2026_08_10_at_07_48_22.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00031_on_2026_08_10_at_07_48_23.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00032_on_2026_08_10_at_07_48_23.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00033_on_2026_08_10_at_07_48_23.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00034_on_2026_08_10_at_07_48_23.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00035_on_2026_08_10_at_07_48_23.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00036_on_2026_08_10_at_07_48_23.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
#> time_taken: 0.114 seconds
#> sql: <SQL>
#>   SELECT *
#>   FROM (
#>     SELECT
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00037_on_2026_08_10_at_07_48_23.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
...
#> ```
#> 
#> ### /tmp/RtmpsEAOIB/sql_folder/logged_query_00038_on_2026_08_10_at_07_48_24.txt
#> 
#> "type: collect
#> schema: results
#> prefix: test_
