...
```{r}
cdm$medications |> sampleCohorts(cohortId = c(1,2), n = 100)

cohortCount(cdm$medications)
```
Note that this function does not reduced the number of records in each cohort, only the number of individuals.
