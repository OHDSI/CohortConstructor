...
Some studies might require a minimum cohort size. We can define the minimum size, filtering out records that are smaller than required, using the `requireMinimumCohortCount` function from CohortConstructor.
...
```{r}
cdm$medications <- cdm$medications %>% 
  requireMinimumCohortCount(minCohortCount = 1000)
